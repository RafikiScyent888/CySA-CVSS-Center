...
export function buildIncident(seed, slot) {
  ...
  if (clientBorne) {
    ...
    var attempts = fam.key === "bruteforce" ? r.int(60, 140) : r.int(14, 30);
  ...
  G.siem = {
    ...
    geoAnomaly: country,
    failedBefore: fam.key === "bruteforce" ? G.fw.attempts : r.int(2, 5),
    noiseLogons: r.int(18, 26)
  };
